...
cardboardRobot.add(legR)
  ...
  cardboardRobot.add(armR);
    ...
    head.position.set(0, legLen + bodyH + headH / 2, 0);
  ...
  eyeL.position.set(eyeSep/2, eyePos,headD/2+0.01);
  head.add(eyeL);

  const eyeR = new THREE.Mesh(eyeGeometry, blackMaterial);
  eyeR.position.set(-eyeSep/2, eyePos,headD/2+0.01);
  head.add(eyeR);
